...
export default function Homepage() {
  ...
  const settings1 = {
    ...
    <Link to="/Contact" >   <button className='w-[147px] h-[46px] bg-purple-900 bg-opacity-80 font-inter font-medium text-white text-5 rounded-lg hover:bg-bYellow hover:text-black'>Get in Touch</button> </Link>
      ...
      <div className='md:mt-16 mt-12 mx-auto flex flex-col justify-center items-center h-full'>
   ...
   <Fade  direction="up" triggerOnce> <div className='bg-graybg shadow-xl flex flex-col justify-center items-center space-y-[40px] md:w-[350px] md:h-[431px] w-[295px] h-[380px] p-6 dark:bg-neutral-900 border-none rounded-xl'>
    ...
    <div className='bg-graybg shadow-xl flex flex-col justify-center items-center space-y-[13px] md:w-[350px] md:h-[431px] w-[300px] h-[380px] p-6 dark:bg-neutral-900 border-none rounded-xl '>
      ...
      />
                        ...
                        <div className=' shadow-xl border border-none rounded-lg bg-graybg md:m-14 m-6 flex  flex-col md:p-12 p-6  md:gap-y-[23px] gap-y-4 font-raleway dark:bg-neutral-900'>
                            <p className='text-bYellow font-raleway leading-[48px] md:text-[32px] text-[25px] font-semibold'>We Work with your</p>

                            <div className='flex flex-col md:gap-y-[22px] gap-y-2 md:text-[16px] text-[16px] text-deepBlue font-medium '>
...
<div className='relative mr-auto top-[10px] space-x-4 bg-graybg  shadow-xl border-lg  flex justify-center items-center w-[236px] h-[68px] mx-[5px] z-10 dark:bg-neutral-900  border-none rounded-lg'>
    ...
    <div className='md:p-12 p-8  relative   bg-graybg  flex flex-col  shadow-xl  border-none rounded-lg dark:bg-neutral-950 mx-6 '>
