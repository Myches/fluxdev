...
export default function Projects() {
    ...
    return (
        ...
        <div className="w-full h-full mt-12 dark:bg-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 m-12 md:gap-12  gap-6 ">
                <img src={banner7} alt="banner" />
                <div className='md:space-y-12 space-y-2 flex flex-col justify-center '>
            ...
            <div className="md:p-8 p-4 md:space-y-12 font-raleway">
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 dark:text-darkGray justify-items-center'>
    {products.map((product) => (
        <div key={product.id} className='grid grid-cols-2 relative md:m-12 m-2 shadow-2xl md:w-[500px] md:h-[500px] h-[300px] w-[300px] cursor-pointer hover:scale-110 transition ease-in-out'>
